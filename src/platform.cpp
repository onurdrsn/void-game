...
void platform_poll_events() {
    ...
    while (XPending(s_dpy)>0) {
        ...
        case ButtonPress:
            ...
            if(ev.xbutton.button==Button2) g_platform.mouse_buttons[2]=true; break;
        case ButtonRelease:
            ...
            if(ev.xbutton.button==Button2) g_platform.mouse_buttons[2]=false; break;
        case MotionNotify: {
        ...
        case ClientMessage:
            if((Atom)ev.xclient.data.l[0]==s_wm_del) g_platform.running=false; break;
        }
    }
    if(s_captured){
